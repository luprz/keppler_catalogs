    ...
    class Install
      class << self
        ...
        def copy_initializer_file
          ...
          copier.copy_file File.join(gem_path, 'lib/templates/catalogs.rb'), File.join(app_path, 'catalogs.rb')
        end
        ...
        def copy_files(directories, origin, destination)
          directories.each do |directory|
            Dir[File.join(origin, directory, 'keppler_catalogs', '**/*')].each do |file|
